            ...
            if (dataOnly) {
                ...
                while (n < x) {
                    ...
                    if (parseLinks) {
                        ...
                        if (printUser) {
                            op += '<div class="user">' + strip(authors[n].innerHTML) + '</div><hr>';
                        }
                    ...
                    if (showInteractionLinks) {
                        op += '<p class="interact"><h2><a href="https://twitter.com/intent/retweet?' + 'tweet_id=' + tids[n] + '" class="twitter_retweet_icon"' +
